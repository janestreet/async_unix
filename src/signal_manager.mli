...
module Behavior_when_no_handlers : sig
  type t =
    | No_op
...
(** [manage t signal] causes [t] to manage [signal], thus overriding
    ...
    The behavior is then controlled by [behavior_when_no_handlers] by default, and the
    collection of handlers installed by [install_handler]/[remove_handler], if used. *)
val manage
  :  t
  -> behavior_when_no_handlers:Behavior_when_no_handlers.t
  -> Signal.t
