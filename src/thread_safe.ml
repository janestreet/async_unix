...
let block_on_async ?(here = Stdlib.Lexing.dummy_pos) f = block_on_async ~here (t ()) f

let block_on_async_exn ?(here = Stdlib.Lexing.dummy_pos) f =
  block_on_async_exn ~here (t ()) f
;;

let run_in_async_wait ?(here = Stdlib.Lexing.dummy_pos) f =
  run_in_async_wait ~here (t ()) f
;;

let run_in_async_wait_exn ?(here = Stdlib.Lexing.dummy_pos) f =
  run_in_async_wait_exn ~here (t ()) f
;;
