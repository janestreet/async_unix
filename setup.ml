(* OASIS_START *)
(* DO NOT EDIT (digest: 2c89d6d7e3e0e8572f926558bb1c8415) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("async_unix", OCamlbuildDocPlugin.doc_build "lib")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("async_unix", OCamlbuildDocPlugin.doc_clean "lib")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
               ...
               Library
                 ({
                      ...
                      },
                   {
                      ...
                      lib_findlib_name = Some "async_unix";
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "Jane street's async library (unix)";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\231\ro\196\215\245\2307O\007\156\200\181!\253\158";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
