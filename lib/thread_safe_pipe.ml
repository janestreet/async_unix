...
let in_async f = Thread_safe.run_in_async_exn f
...
let write_without_pushback' t q = in_async (fun () -> Pipe.write_without_pushback' t q)
let write_without_pushback  t a = in_async (fun () -> Pipe.write_without_pushback  t a)
